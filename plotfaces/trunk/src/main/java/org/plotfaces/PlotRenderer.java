...
public class PlotRenderer extends Renderer {
	...
	encodePlot(out, plotVariable, safeTargetId, dataVariable, optionsVariable);
	encodeScriptEnd(out);
    }

    public void encodeTag(FacesContext context, ResponseWriter out, UIPlot plot) throws IOException {
    ...
    private void encodeOptions(ResponseWriter out, UIPlot plot, String optionsVariable) throws IOException {
    ...
    private void encodePlot(ResponseWriter out, String plotVariable, String safeTargetId, String dataVariable, String optionsVariable) throws IOException {
	out.write("var " + plotVariable + " = $.jqplot('" + safeTargetId + "', [" + dataVariable + "], " + optionsVariable + ")\n");
    }
